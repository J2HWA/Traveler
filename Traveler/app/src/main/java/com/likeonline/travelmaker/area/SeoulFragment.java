...
public class SeoulFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup View = (ViewGroup) inflater.inflate(R.layout.fragment_seoul, container, false);

        ImageButton seoulbtn=(ImageButton) View.findViewById (R.id.seoulbtn);
        seoulbtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                fragmentManager.beginTransaction().remove(SeoulFragment.this).commit();
