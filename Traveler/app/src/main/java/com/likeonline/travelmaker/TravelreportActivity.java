...
public class TravelreportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travel_reportdialog);
        ...
        myRef.child ("users").addValueEventListener(new ValueEventListener () {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child (uid).child ("user_report").getValue ().toString ().equals ("2")&&dataSnapshot.child (destinationUid).child ("user_report").getValue ().toString ().equals ("2")){
                    finish ();
                }
            }
