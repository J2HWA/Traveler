...
public class TravelgoodActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travel_gooddialog2);
...
*/
                ...
                mReference.child("users").child(destinationUid).addListenerForSingleValueEvent (new ValueEventListener () {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        name1=dataSnapshot.child("userName").getValue().toString(); //상대 유저 이름
