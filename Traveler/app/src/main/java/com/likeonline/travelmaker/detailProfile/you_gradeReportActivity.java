...
public class you_gradeReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final DatabaseReference query =  myRef.child("users").child(destinationUid).child("report");
    ...
    public static class ReportListAdapter extends RecyclerView.Adapter<ReportListAdapter.ItemViewHolder> {
        ...
        you_gradeReportActivity gradeReportActivity=new you_gradeReportActivity();
        @NonNull
        @Override
