...
public class Link_Model {
    ...
    public Link_Model(String place_imgUrl, String place_title, String place_tag, Integer place_views, float place_totalrating, float place_reviewCount, String place_category, String post_id) {
