...
public class TravelCustomActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travel_customdialog);

        mPositiveButton=(Button)findViewById(R.id.ok_button1);
        mPositiveButton2=(Button)findViewById (R.id.ok_button2);
        mCancelButton=(Button)findViewById (R.id.cancel_button2);
        ...
        uid =getIntent().getStringExtra("travel_id2"); // 다른 액티비티의 uid 참고
        ...
        myRef.child ("chatrooms").child (chatRoomUid).addValueEventListener (new ValueEventListener () {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child ("user_good").getValue ().toString ().equals ("2")){
                    ...
                    mPositiveButton2.setVisibility (View.VISIBLE);
        ...
        mPositiveButton.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                mReference.child ("chatrooms").child (chatRoomUid).addListenerForSingleValueEvent (new ValueEventListener () {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        dataSnapshot.child ("user_good").getRef ().setValue ("2");
